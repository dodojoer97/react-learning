							...
							<div className="lg:max-w-[640px] lg:mx-auto">
								...
								<div className="mb-6 lg:mb-0">
									...
									<header className="mb-6">
										...
										<p>
											You will soon receive a confirmation email with details
											of your order and a link to download the files.
										</p>
									</header>
									{/* Billing Information */}
									<div>
										...
										<div className="text-center md:text-left md:flex md:items-center md:justify-between space-y-2 md:space-y-0 md:space-x-2">
											...
											<div className="relative inline-flex text-center px-3 py-1 rounded bg-green-500">
												...
												<div
													...
													aria-hidden="true"
												/>
												<span className="text-sm text-green-50 font-medium uppercase">
													XMAS22
												</span>
											</div>
										</div>
										...
										<div className="space-y-6">
											...
											<div className="mt-6">
												...
												<div className="text-xs text-gray-500 italic text-center">
													Should you ever change your mind, we offer a
