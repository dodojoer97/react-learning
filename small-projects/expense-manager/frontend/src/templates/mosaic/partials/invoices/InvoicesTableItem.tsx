...
const InvoicesTableItem: React.FC<InvoicesTableItemProps> = (props) => {
	const totalColor = (status: InvoicesTableItemProps["status"]) => {
		switch (status) {
			case "Paid":
	...
	const statusColor = (status: InvoicesTableItemProps["status"]) => {
		switch (status) {
			case "Paid":
	...
	const typeIcon = (type: InvoicesTableItemProps["type"]) => {
		switch (type) {
			case "Subscription":
				return (
					<svg
