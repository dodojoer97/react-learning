...
function DropdownSwitch({ align }) {
	...
	return (
		<div className="relative">
			...
			<Transition
				className={`origin-top-right z-10 absolute top-full min-w-60 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 py-1.5 rounded-lg shadow-lg overflow-hidden mt-1 ${
