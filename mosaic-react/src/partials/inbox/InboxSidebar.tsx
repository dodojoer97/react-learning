...
interface InboxSidebarProps {
	...
	setInboxSidebarOpen: React.Dispatch<React.SetStateAction<boolean>>;
}

const InboxSidebar: React.FC<InboxSidebarProps> = ({ inboxSidebarOpen, setInboxSidebarOpen }) => {
	return (
		<div
			id="inbox-sidebar"
