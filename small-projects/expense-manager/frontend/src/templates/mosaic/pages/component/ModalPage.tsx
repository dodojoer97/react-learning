													...
													<div className="text-sm">
														...
														<div className="space-y-2">
															...
															<p>
																...
																curabitur vitae. Mattis enim ut
																tellus elementum el fringilla est
																ullamcorper eget nulla. Enim eu
																turpis egestas pretium aenean
																pharetra magna. Aliquam id diam
																maecenas ultricies mi eget us mauris
																vitae ultricies leo integer t
																malesuada fames ac turpis egestas
																maecenas pharetra volutpat lacus
																laoreet non.
															</p>
															<p>
																Lorem ipsum dolor sit amet,
														...
														<div className="text-sm mb-10">
															<div className="space-y-2">
																<p>
																	...
																	pellentesque lacus suspendisse
																	faucibus interdum.
																</p>
															</div>
														</div>
											...
											>
												...
												<div className="text-center">
													...
													<div className="text-xs text-gray-500 italic mt-3">
														I respect your privacy. No spam. Unsubscribe
														at any time!
													</div>
												</div>
											</ModalAction>
											...
											>
												...
												<div className="text-sm mb-5">
													...
													<div className="text-xs text-gray-500">
														By clicking on Allow access, you authorize
														Mosaic to use your information in accordance
														with its{" "}
														<a
														...
														integrations page of your Mosaic account.
													</div>
												</div>
												{/* Modal footer */}
												<div className="flex flex-wrap justify-end space-x-2">
													...
													<div className="text-sm mb-5">
														<div className="space-y-2">
															<p>
																...
																but every frame, digital video,
																canvas, responsive design, and image
																often has a rectangular shape that
																is exceptionally precise in
																proportion (or ratio).
															</p>
															<p>
																The ratio has to be well-defined to
																make shapes fit into different and
																distinct mediums, such as computer,
																movies, television and camera
																screens.
															</p>
														</div>
													</div>
											...
											>
												...
												<div className="px-5 pt-4 pb-1">
													<div className="text-sm">
														...
														<div className="text-xs text-gray-500">
															Your workspace’s Mosaic Light Plan is
															set to $39 per month and will renew on
															August 9, 2024.
														</div>
													</div>
												</div>
