...
const FintechCard13: React.FC = () => {
	const chartData = {
		...
		datasets: [
			...
			{
				data: [
					245, 288, 332, 404, 404, 314, 314, 314, 314, 314, 234, 314, 234, 234, 314, 314,
					314, 388, 314, 202, 202, 202, 202, 514, 720, 642,
				],
				fill: true,
			...
			<div className="px-5 pt-5">
				<header>
					<h3 className="text-sm font-semibold text-gray-500 uppercase mb-1">
						<span className="text-gray-800 dark:text-gray-100">Facebook</span> - Meta
						Inc.
					</h3>
