	...
	return (
		<div className="grow px-4 sm:px-6 md:px-5 py-6">
			...
			<div className="flex items-start mb-4 last:mb-0">
				...
				<div>
					<div className="text-sm bg-violet-500 text-white p-3 rounded-lg rounded-tl-none border border-transparent mb-1">
						Sed euismod nisi porta lorem mollis. Tellus elementum sagittis vitae et leo
						duis. Viverra justo nec ultrices dui.
						<br />
						Sed lectus vestibulum mattis ullamcorper velit sed. Ut sem nulla pharetra
						diam sit amet 🎁
					</div>
					<div className="flex items-center justify-between">
